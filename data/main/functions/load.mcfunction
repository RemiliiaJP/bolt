...
### --- Scoreboards --- ###
# Ryukkun_
scoreboard objectives add fox_main dummy
...
execute unless score $arrowMode fox_settings matches -2147483648..2147483647 run scoreboard players set $arrowMode fox_settings 0
...
# Version表記
data merge storage fox:main {Version:[[1,4,0],[0,0,6]]}
